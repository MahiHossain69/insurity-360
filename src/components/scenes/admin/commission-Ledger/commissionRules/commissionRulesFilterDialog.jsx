...
export default function commissionRulesFilterDialog({
  open,
  onOpenChange,
  status,
  setStatus,
        ...
        <div className="space-y-8 overflow-y-auto max-h-[50vh] px-1 sm:px-2">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:space-x-6">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="policy-type" className="text-sm font-medium text-neutral-900 font-geist">
                  Policy Type
                </Label>
                <Select value={policyType} onValueChange={setPolicyType}>
                  <SelectTrigger id="policy-type" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="producer-name" className="text-sm font-medium text-neutral-900 font-geist">
                  Producer Name
                </Label>
                <Select value={producerName} onValueChange={setProducerName}>
                  <SelectTrigger id="producer-name" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="agent" className="text-sm font-medium text-neutral-900 font-geist">
                  Agent
                </Label>
                <Select value={agent} onValueChange={setAgent}>
                  <SelectTrigger id="agent" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="broker-name" className="text-sm font-medium text-neutral-900 font-geist">
                  Broker Name
                </Label>
                <Select value={brokerName} onValueChange={setBrokerName}>
                  <SelectTrigger id="broker-name" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="carrier" className="text-sm font-medium text-neutral-900 font-geist">
                  Carrier
                </Label>
                <Select value={carrier} onValueChange={setCarrier}>
                  <SelectTrigger id="carrier" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="premium-type" className="text-sm font-medium text-neutral-900 font-geist">
                  Premium Type
                </Label>
                <Select value={premiumType} onValueChange={setPremiumType}>
                  <SelectTrigger id="premium-type" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:space-x-6">
            ...
            <div className="flex flex-col w-full sm:flex-row sm:flex-wrap gap-4">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium text-neutral-900 font-geist">Commission Date</Label>
              ...
              <div className="space-y-2 min-w-70">
                <Label htmlFor="commission-premium-type" className="text-sm font-medium text-neutral-900 font-geist">
                  Commission Status
                </Label>
                <Select value={commissionPremiumType} onValueChange={setCommissionPremiumType}>
                  <SelectTrigger id="commission-premium-type" className="h-10 min-w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
                    <SelectItem value="single">Single</SelectItem>
          ...
          <div className="flex flex-col md:flex-row md:items-start md:space-x-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="auto-renewal" className="text-sm font-medium text-neutral-900 font-geist cursor-pointer">
