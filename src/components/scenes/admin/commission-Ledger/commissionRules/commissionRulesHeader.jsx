...
import { AddNewRuleModal } from "@/components/scenes/admin/commission-Ledger/commissionRules/addNewRuleModal";
import {
  AddNewPlusIcon,
  PolicySearchIcon,
  RowDownIcon,
...
export default function CommissionRulesHeader({
  searchInput,
  setSearchInput,
  rowsPerPage,
  setRowsPerPage,
  ...
  return (
    <div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              className="font-geist cursor-pointer bg-blue-500 text-sm font-semibold text-white hover:bg-blue-500/90"
            >
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetContent
          side="right"
          className="flex w-full flex-col p-0 sm:max-w-160"
        >
          <SheetHeader className="border-b border-neutral-200 p-6">
            <SheetTitle className="text-base font-semibold text-neutral-900">
              Add New Rule
            </SheetTitle>
          </SheetHeader>
          <div className="flex-1 overflow-y-auto">
            <AddNewRuleModal onClose={handleClose} />
          </div>
        </SheetContent>
      </Sheet>
    </div>
