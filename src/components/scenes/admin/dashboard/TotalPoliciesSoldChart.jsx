...
const TotalPoliciesSoldChart = ({ data, className = "" }) => {
      ...
      return (
        <div className="rounded-lg border border-neutral-200 bg-white p-3 shadow-lg">
          ...
          <p className="text-sm font-medium text-[#FF8C00]">
            {`Policies: ${payload[0].value.toLocaleString()}`}
          </p>
        </div>
      );
    }
  ...
  return (
    ...
    >
      {/* Header with Tabs */}
      <div className="">
        <div className="flex items-center justify-between border-b border-gray-200 py-2 pr-2 pl-6">
        ...
        {/* Stats Header */}
        <div className="mb-6 bg-[#FFFAEB] p-4">
      ...
      <div className="flex items-center justify-center space-x-2 pb-4">
        <div className="h-3 w-3 bg-[#FF8C00]"></div>
...
export default TotalPoliciesSoldChart;
