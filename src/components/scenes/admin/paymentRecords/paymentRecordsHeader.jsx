...
export default function paymentRecordsHeader({
  searchTerm,
  setSearchTerm,
  rowsPerPage,
  setRowsPerPage,
          ...
          <div className="flex flex-col gap-1">
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbLink asChild>
                    <Link href="/payments/records" className="text-neutral-900 font-urbanist font-normal text-sm">
                      Payment Records
                    </Link>
                  </BreadcrumbLink>
                </BreadcrumbItem>
            ...
            <h1 className="text-xl sm:text-2xl font-medium font-urbanist text-neutral-900">Payment Records</h1>
          </div>

          <div className="flex flex-wrap gap-2">
           
            <Link href="/payments/records/addNewRecords">
