  ...
  return (
    <div style={{ maxWidth: "800px" }}>
      <div className="space-y-6">
        ...
        <div className="space-y-4 rounded-lg bg-neutral-50 p-4 2xl:min-w-[1200px]">
          ...
          <div className="hidden w-full flex-row gap-3 sm:flex">
            <Label className="text-sm font-medium text-neutral-900 sm:w-[50%]">
              Name
            </Label>
            <Label className="text-sm font-medium text-neutral-900 sm:w-[25%]">
              Email
            </Label>
            <Label className="text-sm font-medium text-neutral-900 sm:w-[25%]">
              Relation
