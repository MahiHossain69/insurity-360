...
export default function FilterDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`fixed top-0 left-0 right-0 max-w-none w-full h-auto max-h-[99vh] overflow-hidden rounded-none border-0 border-b shadow-lg translate-x-0 translate-y-0  sm:rounded-none transform transition-transform duration-300 ease-in-out
        ...
        <div className="space-y-8 overflow-y-auto max-h-[50vh] px-1 sm:px-2">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:space-x-6">
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="product-name" className="text-sm font-medium text-neutral-900 font-geist">
                  Product Name
                </Label>
                <Select value={productName} onValueChange={setProductName}>
                  <SelectTrigger id="product-name" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="payment-frequency" className="text-sm font-medium text-neutral-900 font-geist">
                  Payment Frequency
                </Label>
                <Select value={paymentFrequency} onValueChange={setPaymentFrequency}>
                  <SelectTrigger id="payment-frequency" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
              ...
              <div className="space-y-2">
                <Label htmlFor="policy-holder-type" className="text-sm font-medium text-neutral-900 font-geist">
                  Policy Holder Type
                </Label>
                <Select value={policyHolderType} onValueChange={setPolicyHolderType}>
                  <SelectTrigger id="policy-holder-type" className="h-10 w-full border border-neutral-300">
                    <SelectValue placeholder="" />
                  </SelectTrigger>
                  <SelectContent className="bg-white font-geist">
