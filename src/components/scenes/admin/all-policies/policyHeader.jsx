      ...
      <div className="w-full bg-white pb-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              variant="outline"
              className="font-geist cursor-pointer border-neutral-300 text-sm font-semibold text-neutral-900 hover:bg-slate-100/50"
            >
              <Download className="mr-2 h-4 w-4 text-neutral-900" />
              NIPR Import
            </Button>
            <Link
              href="/policies/add-new-opportunity"
              className="font-geist flex cursor-pointer items-center gap-1 rounded-md bg-blue-500 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500/90"
            >
