...
import { AddNewPlusIcon, PolicySearchIcon, RowDownIcon } from "@/components/shared/svgs";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
           ...
           <Link href="/policies/claims/add-new-claim">
            <Button
              className="bg-blue-500 cursor-pointer font-geist font-semibold text-sm hover:bg-blue-500/90 text-white flex items-center gap-1"
              
            >
              <AddNewPlusIcon className="text-white mr-2 w-4 h-4" />
              Add New Claim
            </Button>
           </Link>
          </div>
          ...
          <div className="flex flex-wrap gap-1 items-center">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  className="border-neutral-300 cursor-pointer text-neutral-900 font-semibold bg-transparent font-geist"
                >
                  {rowsPerPage} Rows
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-900 font-geist text-sm px-2">
